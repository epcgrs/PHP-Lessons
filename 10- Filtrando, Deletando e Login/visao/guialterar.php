		...
		<div id="page">
			<div id="content">
				...
				<div class="post">
					...
					<form name="cad" id="cad" method="post" action="../controle/usuariocontrole.php?op=confirmalterar">



						<label>codigo:</label> <br />
						<input type="text" name="txtidusuario" id="txtidusuario" value="<?php echo $usu[0]->idUsuario; ?>" />

						<label>login:</label> <br />
						<input type="text" name="txtlogin" id="txtlogin" value="<?php echo $usu[0]->login; ?>" />

						<label>senha:<input type="text" name="txtsenha" id="txtsenha" value="<?php echo $usu[0]->senha; ?>" />*</label> <br />        
						<label>tipo:
